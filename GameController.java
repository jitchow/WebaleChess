...
public class GameController implements ActionListener     
{
    ...
    //Whether it is the time to change "Triangle" and "Plus"
    private boolean changedPlusTri = false;
    ...
    {
        //Index 0 is the String that determines whether the "Plus" and "Triangle" have changed
        if (gameInfo.get(0).equals("false"))
            changedPlusTri = false;
        else
            changedPlusTri = true;
        
        //Index 1 and 2 is the number of moves each player have made
        players[0].setMoves(Integer.parseInt(gameInfo.get(1)));
        players[1].setMoves(Integer.parseInt(gameInfo.get(2)));
        
        //Index 3 is the String that determines which player is currently playing
        if (gameInfo.get(3).equals("Red"))
    ...
    public void changeButton(int i,int j,char sourceI,char sourceJ)//locationIJ is source chess location,ij is destination
    {
        ...
        //Add the moves of player and switch player's turn
        ...
        if (currentPlayer.getMoves() != 0 && currentPlayer.getMoves()%2 == 0 && !changedPlusTri)
        {
            board.changePlusTri();
            changedPlusTri = true;
    ...
    public void resetGameSetting()
    {
        ...
        changedPlusTri = false;//Set to default
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (e.getActionCommand().equals("Save Game"))//Done by Lim Yixen
        {
            ...
            savedGameFileName = gm.saveGame(chessDetails,changedPlusTri,players[0].getMoves(),players[1].getMoves(),currentPlayer.getColour());
